...
- experimental_ble_app_linking_beacon demonstrates Linking beacon with SoC temperature sensor. The implementation is based on Nordic Solar Beacon project (https://github.com/NordicPlayground/solar_sensor_beacon), which does not use softdevice and requires no SDK. Tested with DoCoMo LinkIFDemo.apk from Linking Android SDK.
